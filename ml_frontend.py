...
if uploaded_file:
    ...
    # FIX: Use st.cache_resource to cache the model (replaces deprecated @st.cache)
    # Models are shared resources — loaded once and reused across sessions
...
# Raw data / strings fetched from network → use cache_data
